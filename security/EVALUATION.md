...
&gt; Results are generated from mock signals with controlled randomness (seed=42).  
...
|--------|-------|-------------|
| APCER | 6.7% | Attack sessions ending as "Trusted" (1/15) |
...
- **Wrong Person** is the weakest attack vector in this dataset: identity similarity 0.20–0.50 combined with passed liveness can still score 78–81, occasionally crossing into "Trusted". This is addressed by the identity threshold hardening rule (identity &lt; 0.6 → max Suspicious).
